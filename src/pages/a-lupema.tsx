  ...
  return (
    <>
      <section className="container mt-[100px] sm:mt-[74px] py-[40px] md:py-[80px]">
        <h1 className="title !font-bold">A LUPEMA ENGENHARIA</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 mt-8">
          <div className="h-full">
            ...
            <span className="h-[25px] w-[75%] block ml-[20%] sm:ml-[25%] border-b border-l border-r border-green"></span>
            <p
          ...
          <div className="z-0 sticky top-[50px] sm:top-[80px] h-[600px]">
            <div className="flex justify-center my-4">
              <h1 className="px-4 py-4 text-green text-5xl font-light w-[100%] sm:w-[80%]">
                {data.page?.titulo}
              </h1>
            </div>
            <span className="h-[25px] w-[75%] xl:w-[50%] ml-[15px] sm:ml-[0] block border-t border-r border-l border-green"></span>
