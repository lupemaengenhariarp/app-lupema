      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
        <div>
          ...
          <div className="my-6">
            ...
            <p className="text-green font-semibold mb-2 w-max block">
              • Atualizar seu cadastro
            </p>
            <p className="text-green font-semibold w-max block">
          ...
          <div className="flex items-center mt-6">
            ...
            >
              <BsFacebook size={26} className="text-green" />
            </a>
            <a className="px-3" href={data.social.linkInstagram}>
              <IoLogoInstagram size={32} className="text-green" />
            </a>
            <a href={data.social.linkYoutube}>
              <IoLogoYoutube size={32} className="text-green" />
            </a>
          </div>
        </div>
        <div>
