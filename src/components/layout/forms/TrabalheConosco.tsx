    ...
    <>
      ...
      <div className="block w-full">
        <div className="mt-3 flex items-center">
          <span className="px-2 border-y border-green border-l py-[7px] border-r-black/10 border-r">
            R$
          </span>
          <input
            type="text"
            placeholder="Pretensão salarial 1"
...
const Stage1 = ({ values, errors, touched, handleChange }: any) => {
  const KeyUpDataNascimento = useCallback((e: any) => {
    return DataNascimento(e);
  }, []);
  return (
    <>
...
const Stage2 = ({ values, errors, touched, handleChange }: any) => {
  const KeyUpCep = useCallback((e: any) => {
    return Cep(e);
  }, []);
  return (
    <>
...
const Stage3 = ({ values, errors, touched, handleChange }: any) => {
  const KeyUpTelefone = useCallback((e: any) => {
    return Telefone(e);
  }, []);
  return (
    <>
    ...
    <>
      <div>
        ...
        <p className="mb-6">
          ...
          <a href="/politica-de-privacidade" className="mx-2 underline italic">
            política de privacidade
          </a>
          e consinto com o tratamento dos dados aqui inseridos para a finalidade
